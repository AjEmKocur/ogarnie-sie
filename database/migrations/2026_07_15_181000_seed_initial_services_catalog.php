...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $services = [
            ...
            ['Sieci domowe', 'Konfiguracja routera lub WiFi', 'Ustawienie routera, nazwy sieci, hasła oraz podstawowych parametrów domowego połączenia.', 100, 10],
            ...
            ['Sieci domowe', 'Sprawdzenie problemów z internetem', 'Podstawowa diagnostyka zasięgu WiFi, połączeń kablowych i konfiguracji domowej sieci.', 80, 30],
