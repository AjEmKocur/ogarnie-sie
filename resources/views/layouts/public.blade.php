...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Kocur Serwis Komputerowy - składanie PC, modernizacja komputerów, diagnostyka laptopów, instalacja systemów i pomoc z siecią domową w Jarosławiu i okolicach.')">
        ...
        <header class="og-topbar sticky top-0 z-40 border-b border-gray-200 bg-slate-950/90 backdrop-blur">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 sm:px-6 lg:px-8">
                ...
                <nav class="hidden items-center gap-6 text-base font-medium md:flex">
                    ...
                    <a href="{{ route('public.services') }}" class="{{ request()->routeIs('public.services*') ? 'text-amber-300' : 'text-white/85 hover:text-amber-200' }}">Usługi</a>
