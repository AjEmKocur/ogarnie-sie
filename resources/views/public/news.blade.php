...
@section('content')
    <section class="mx-auto max-w-7xl px-5 py-16 sm:px-6 lg:px-8">
        ...
        <p class="mt-4 text-slate-300">Przykłady wykonanych prac, modernizacji i zestawów przed oraz po realizacji.</p>
            ...
            <div class="grid gap-4 sm:grid-cols-2 2xl:grid-cols-3">
                ...
                @empty
                    <article class="rounded-xl border border-gray-200 bg-white p-5 md:col-span-2">
                        <h2 class="mt-2 text-lg font-semibold">Brak realizacji</h2>
