...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-blue-400 text-start text-base font-medium text-slate-100 bg-slate-800 focus:outline-none focus:text-white focus:bg-slate-700 focus:border-blue-500 transition duration-150 ease-in-out'
