        ...
        <div class="max-w-7xl mx-auto space-y-6 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                @if (auth()->user()->hasAdminPermission('tickets'))
                    <a href="{{ route('admin.tickets.index') }}" class="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:!border-amber-400/80 hover:!bg-slate-800/80 transition-all duration-200 min-h-[220px] flex flex-col">
                ...
                @if (auth()->user()->hasAdminPermission('cms_services'))
                    <a href="{{ route('admin.cms.services.index') }}" class="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:!border-amber-400/80 hover:!bg-slate-800/80 transition-all duration-200 min-h-[220px] flex flex-col">
                    ...
                    <a href="{{ route('admin.cms.about-gallery.index') }}" class="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:!border-amber-400/80 hover:!bg-slate-800/80 transition-all duration-200 min-h-[220px] flex flex-col">
                ...
                @if (auth()->user()->hasAdminPermission('cms_news'))
                    <a href="{{ route('admin.cms.news.index') }}" class="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:!border-amber-400/80 hover:!bg-slate-800/80 transition-all duration-200 min-h-[220px] flex flex-col">
                        <p class="text-sm uppercase tracking-wider text-gray-500">Treści</p>
                ...
                @if (auth()->user()->hasAdminPermission('testimonials_moderation'))
                    <a href="{{ route('admin.testimonials.index') }}" class="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:!border-amber-400/80 hover:!bg-slate-800/80 transition-all duration-200 min-h-[220px] flex flex-col">
                        <p class="text-sm uppercase tracking-wider text-gray-500">Treści</p>
                ...
                @if (auth()->user()->isMainAdmin())
                    <a href="{{ route('admin.team.index') }}" class="group rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:!border-amber-400/80 hover:!bg-slate-800/80 transition-all duration-200 min-h-[220px] flex flex-col">
